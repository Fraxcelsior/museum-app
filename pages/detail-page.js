...
//Error messages. If Either input field is left empty, or if the text is too long, it prints an appropriate alert.
...
function doesNotPassAllValidations(name, msg) {
   ...
   let profanityCheckMsg = inputMsg.includes(profanityFilter[''] );
    ...
    if (profanityCheckName === true) {
        console.log("Name is in array");
        alert("Language, Captain! Your name contains profanity.");
        return true;
    }

    if (profanityCheckMsg === true) {
        console.log("Message is in array");
        alert('Language, Captain! Your message contains profanity');
        return true;
    }
    return false;
}
...
function submitComment() {
    ...
    // This checks if the validation function returns true. If true, it does not post anything and  stops the code.
